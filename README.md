...
<%= aria.grid.tag id: "grid-table" do |builder| %>
  ...
  <tbody>
    <%= builder.grid.row_target.tag.tr do %>
      <%= builder.grid.gridcell_target.tag.td "A1" %>
      <%= builder.grid.gridcell_target.tag.td "A2" %>
      <%= builder.grid.gridcell_target.tag.td "A3" %>
    <% end %>

    <%= builder.grid.row_target.tag.tr do %>
      <%= builder.grid.gridcell_target.tag.td "B1" %>
      <%= builder.grid.gridcell_target.tag.td "B2" %>
      <%= builder.grid.gridcell_target.tag.td "B3" %>
    <% end %>
  </tbody>
<% end %>
```
